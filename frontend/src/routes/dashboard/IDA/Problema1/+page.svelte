<script>
    ...
    let dejaRezolvata = $state(false);
     ...
     onMount(() => {
        if (localStorage.getItem('problema_1_ida_rezolvata') === 'true') {
            dejaRezolvata = true;
        }
    ...
    if (rezultat.corect) {
        ...
        if (rezultat.status === 'finalizat') {
            ...
            localStorage.setItem('problema_1_ida_rezolvata', 'true');
            dejaRezolvata = true;
...
<div class="ecran-start" style:display={pornit ? 'none' : 'flex'}>
    <h1>Problema 1: Iterative Deepening A* Search</h1>
    {#if dejaRezolvata}
...
<div bind:this={zonaProblema} class="container-problema-noua" style:display={pornit ? 'block' : 'none'}>
    ...
    <div class="bara-enunt-global">
        ...
        <div class="zona-imagine-graf">
            <img src="/poze/problema_1_ida.png" alt="Graful problemei UCS" class="poza-graf-noua">
        </div>
    </div>
