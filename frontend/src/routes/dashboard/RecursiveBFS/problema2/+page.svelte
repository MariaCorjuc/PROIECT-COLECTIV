<script lang="ts">
  ...
  const problema2 = {
    titlu: "Problema 2: Căutare RBFS (Ruta București - Sighișoara)",
    cerinta: "Folosind harta și tabelul de euristici din stânga, reconstruiți arborele de căutare rezultat prin aplicarea algoritmului Recursive Best First Search (RBFS). Dați click stânga pe noduri pentru a le edita valoarea f(n) modificată prin backtracking sau limitele active, și Click-Dreapta pentru a le tăia.",
    noduriDisponibile: ['București', 'Buzău', 'Pitești', 'Târgoviște', 'Brașov', 'Făgăraș', 'Râmnicu Vâlcea', 'Sibiu', 'Mediaș', 'Sighișoara'],
    
    solutiePerfecta: [
      { nod: 'București', parinte: null, valoare: '223', limita: '∞' },
      { nod: 'Târgoviște', parinte: 'București', valoare: '314', limita: '232' }, 
      { nod: 'Pitești', parinte: 'București', valoare: '307', limita: '269' },
      { nod: 'Buzău', parinte: 'București', valoare: '393', limita: '306' },
      { nod: 'Brașov', parinte: 'Târgoviște', valoare: '314', limita: '291' },
      { nod: 'Făgăraș', parinte: 'Târgoviște', valoare: '342', limita: '305' },
      { nod: 'Buzău', parinte: 'Târgoviște', valoare: '393', limita: "" },
      { nod: 'Râmnicu Vâlcea', parinte: 'Pitești', valoare: '307', limita: '307' },
      { nod: 'Făgăraș', parinte: 'Brașov', valoare: '314', limita: "" },
      { nod: 'Sighișoara', parinte: 'Făgăraș', valoare: '342', limita: "" },
      { nod: 'Sibiu', parinte: 'Râmnicu Vâlcea', valoare: '345', limita: "" },
      { nod: 'Mediaș', parinte: 'Sibiu', valoare: '366', limita: "" }
    ]
  };
  ...
  onMount(() => {
    noduriArbore = [{ id: idContor++, eticheta: 'București', euristica: '223', limita: '∞', parinteId: null, taiat: false }];
  ...
  <div class="corp-interactiv">
    ...
    <div class="panou-stanga-graf">
      ...
      <div class="container-imagine">
        <img src="/poze/AEX2.png" alt="Harta României cu distanțe și euristici pentru Sighișoara" />
      </div>
    </div>

    <div class="zona-desen">
      <p class="instructiune-scurta">Indicație: Click stânga pe nod pentru editare valori/părinte, Click-Dreapta pentru a-l tăia.</p>
      ...
      {#if afiseazaMeniuAdaugare}
        <div class="fundal-intunecat-modal">
          <div class="interfata-adaugare-interna">
            ...
            <input id="input-limita" type="text" placeholder="Lasă gol SAU introduceți limita" bind:value={limitaInput} />
      ...
      {#if afiseazaMeniuEditare}
        <div class="fundal-intunecat-modal">
          <div class="interfata-adaugare-interna editare-speciala">
            ...
            <input id="edit-limita" type="text" placeholder="Ex: 269 sau lăsați gol" bind:value={limitaInput} />
...
<style>
  ...
  .instructiune-scurta::after {
    content: " | Click-Dreapta pe nod pentru a-l tăia vizual.";
    color: #ef4444;
    font-weight: normal;
  }
  .canvas-legaturi {
